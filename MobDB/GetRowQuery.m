...
-(GetRowQuery*)initWithTableName:(NSString *)table{
    query = [NSMutableString stringWithFormat:@"SELECT * FROM %@",table];
    return self;
}
...
-(NSString*) getQueryString{
    ...
    if( fields != nil ){
        ...
        if([fields count] > 0){
            ...
            NSMutableString* field = [NSMutableString stringWithString:(NSString*)[fields objectAtIndex:0]];     
            ...
            if([field length] > 0){
                ...
                query = [[query stringByReplacingOccurrencesOfString:@"SELECT * FROM" withString:[NSString stringWithFormat:@"SELECT %@ FROM",field]] mutableCopy];
